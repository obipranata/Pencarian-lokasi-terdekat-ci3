        ...
        <div class="row">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url(); ?>admin/lokasi_atm/tambah" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Nama Lokasi</label>
                                        <input type="text" class="form-control" name="nama_lokasi" value="<?= set_value('nama_lokasi'); ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <select class="form-control" id="id_atm" name="id_bank_atm">
                                            <option class="bmd-label-floating" disabled selected>Pilih ATM</option>
                                            <?php foreach ($atm as $b) { ?>
                                                <option class="text-dark" value="<?= $b['id_atm']; ?>"><?= $b['nama_atm']; ?></option>
                                            <?php } ?>
                                        </select>
                                        <small class="text-warning">
                                            <?php echo form_error('id_bank_atm'); ?>
                                        </small>
                                    </div>
                                </div>
                                <div class="col-md-12">
