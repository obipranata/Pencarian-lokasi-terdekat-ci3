        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url(); ?>admin/lokasi_atm/ubah/<?= $lokasi['id_lokasi']; ?>" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="bmd-label-floating" for="id_atm">ATM</label>
                                        <select class="form-control" id="id_atm" name="id_bank_atm">
                                            <option class="bmd-label-floating">-Pilih-</option>
                                            <?php foreach ($atm as $b) { ?>
                                                <?php
                                                if ($b['id_atm'] == $lokasi['id_bank_atm']) {
                                                    $selected = 'selected';
                                                } else {
                                                    $selected = '';
                                                }
                                                ?>
                                                <option <?= $selected; ?> class="text-dark" value="<?= $b['id_atm']; ?>"><?= $b['nama_atm']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row row-sm mg-t-20">
                                        <input type="hidden" id="lat" class="form-control col-xs-5 col-md-5" name="latitude" value="<?= $lokasi['latitude']; ?>">
                                        <input type="hidden" id="lng" class="form-control col-xs-5 col-md-5" name="longitude" value="<?= $lokasi['longitude']; ?>">
                                    </div>
                                </div>
                            </div>
